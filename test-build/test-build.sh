...
./rancher-compose --debug --url http://52.78.73.245:8080/v1/projects/1a5 --access-key 991E0C04928D36A1394A --secret-key t5XMFcGQdZgDrZPwxqpoZVRQtUxgHWpuEn4MJN66 -p python-redis-demo-build${BUILD_NUMBER} up -d
