...
./rancher-compose --debug --url http://52.78.73.245:8080/v2-beta --access-key 811E9C1B61479FF0BBCA --secret-key GCuVUSap2poayDiMwUhDnK8PH1tCs4XYYVrkkkDo -p python-redis-demo-build${BUILD_NUMBER} up -d 
